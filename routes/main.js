...
const {
    home, about, cars, pricing, contact, rent, postCarPage, postCar, editCarPage, editCar, deleteCar, postRent, singleCar, rented, adminPage
} = require('../controllers/main')

const {authAdmin, authMiddleware} = require('../middleware/authentication')
...
router.get('/rent/:id',authMiddleware, rent)
...
router.post('/rent/:id',authMiddleware, postRent)
router.get('/rented-cars', authMiddleware, rented)
